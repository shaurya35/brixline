...
export default function Home() {
  return (
    <>
      {/* <header className="relative h-[817px] w-full bg-[url('/main-image-dark.svg')] bg-cover bg-left px-4 sm:px-10 lg:px-30 2xl:px-72 ">
        ...
        <div className="relative flex justify-between items-start sm:items-center flex-wrap h-[714px]">
          <div className="text-white h-[400px]">
            <div className="text-4xl sm:text-5xl lg:text-6xl font-black leading-11 sm:leading-15 lg:leading-20">
              Get Your Dream <br /> Home Delivered On <br /> Time
            </div>
            <div className="text-md sm:text-lg lg:text-xl font-normal leading-5 sm:leading-6 lg:leading-8 opacity-60 pt-4">
      ...
      <header className="relative h-[817px] w-full bg-[url('/main-image-dark.png')] bg-cover bg-left">
