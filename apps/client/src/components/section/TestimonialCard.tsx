...
const TestimonialCard = () => (
  <div className="h-[246px] w-[382px] md:w-[511px] md:h-[348px] px-7 py-10 border rounded-2xl border-black/5">
    ...
    <Image
      ...
      width={42}
      height={2}
      className="w-10 mt-2 md:mt-7 hidden md:block"
    />
    <div className="text-sm md:text-base mt-2 md:mt-7">Rahul Garg</div>
  </div>
);
